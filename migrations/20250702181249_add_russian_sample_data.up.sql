...
INSERT INTO items (title, description, price, author_id, location, category_id, tags, has_photos) VALUES
('iPhone 14 Pro', 'Современный смартфон Apple в отличном состоянии. Идеально подходит для работы и развлечений.', 50000, 1, 'Алматы, ул. Достык 123', 1, ARRAY['смартфон', 'apple', 'техника'], true),
('Велосипед горный', 'Качественный горный велосипед для активного отдыха. Подходит для катания по городу и за городом.', 15000, 2, 'Астана, пр. Республики 45', 3, ARRAY['велосипед', 'спорт', 'отдых'], true),
('Книга "Война и мир"', 'Классическое произведение Льва Толстого в твердом переплете. Отличное состояние.', 2000, 3, 'Алматы, ул. Абая 67', 4, ARRAY['книга', 'классика', 'литература'], false),
('Платье вечернее', 'Элегантное вечернее платье черного цвета. Размер M, идеально для торжественных мероприятий.', 8000, 4, 'Астана, ул. Бейбитшилик 89', 2, ARRAY['платье', 'вечернее', 'элегантное'], true),
('Ноутбук Dell', 'Мощный ноутбук для работы и учебы. Intel i7, 16GB RAM, SSD 512GB.', 120000, 1, 'Алматы, ул. Толе би 234', 1, ARRAY['ноутбук', 'dell', 'компьютер'], true),
('Футбольный мяч', 'Профессиональный футбольный мяч для тренировок и игр. Размер 5.', 3000, 5, 'Астана, ул. Кенесары 12', 3, ARRAY['футбол', 'мяч', 'спорт'], false),
('Кофемашина', 'Автоматическая кофемашина для приготовления эспрессо и капучино. В отличном состоянии.', 25000, 2, 'Алматы, ул. Фурманова 56', 5, ARRAY['кофе', 'машина', 'кухня'], true),
('Гитара акустическая', 'Красивая акустическая гитара для начинающих музыкантов. Включает чехол и медиатор.', 18000, 3, 'Астана, ул. Сарыарка 78', 8, ARRAY['гитара', 'музыка', 'инструмент'], true);
